<?php
/**
 * Defines the EvetPage page type
 */
class EventPage extends Page {
   ...
   /** static $icon = "icon/path"; */
 	...
 	function getCMSFields() {
		...
		$fields->addFieldToTab('Root.Content.Main', $EventStartDate, 'Content');
		...
		$fields->addFieldToTab('Root.Content.Main', $EventEndDate, 'Content');
		    	
    	$fields->addFieldToTab('Root.Content.Main', new TextField('EventLink','Event Button Link (URL)'), 'Content');
    	$fields->addFieldToTab('Root.Content.Main', new TextField('EventLinkLabel','Event Button Label'), 'Content');
    	
    	$fields->addFieldToTab('Root.Content.Main', new TextField('EventLocation','Event Location'), 'Content');
    	$fields->addFieldToTab('Root.Content.Main', new TextField('EventSponsor','Event Sponsor'), 'Content');
    	$fields->addFieldToTab('Root.Content.Main', new TextField('EventSponsorLogoUrl','URL of the Event Sponsor Logo'), 'Content');
    	
    	$fields->addFieldToTab('Root.Content.Main', new CheckboxField ('IsSummit','Official OpenStack Summit Event'), 'Content');
